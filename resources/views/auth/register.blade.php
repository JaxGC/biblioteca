            ...
            <div class="col-lg-6 col-md-8">
                <div class="card bg-secondary shadow border-0">
                    <!--div class="card-header bg-transparent pb-5">
                        <div class="text-muted text-center mt-2 mb-4"><small>{{ __('Iniciar Sesion') }}</small></div>
                    ...
                    <div class="card-body px-lg-5 py-lg-5 fondoBusqueda" >
                        ...
                        <form role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="text-muted font-italic">
                                <small>{{ __('Usa una contraseña larga') }}: <span class="text-success font-weight-700">{{ __('Larga') }}Larga</span></small>
                            </div>
                            <div class="row my-4">
                                <div class="col-12">
                                    <div class="custom-control custom-control-alternative custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="customCheckRegister">
                                            <span class="text-muted">{{ __('Estoy de acuerdo') }} <a href="#!">{{ __('Politica de privacidad') }}</a></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
