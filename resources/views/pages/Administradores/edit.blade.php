    ...
    <div> 
        ...
        <div class="card shadow">
            ...
            <div class="col-sm"><strong>
                ...
                <input id="password" name="password" class="form-control form-control-muted" type="password" required autofocus>
            </div>
            <div class="col-sm">
