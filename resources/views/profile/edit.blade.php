                    ...
                    <div class="card-body pt-0 pt-md-4">
                        <div class="row">
                            <div class="col">
                                <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                    <div>
                                        <span class="heading">{{ date('d') }}</span>
                                        <span class="description">{{ __('Dia') }}</span>
                                    </div>
                                    <div>
                                        <span class="heading">{{ date('m') }}</span>
                                        <span class="description">{{ __('Mes') }}</span>
                                    </div>
                                    <div>
                                        <span class="heading">{{ date('Y') }}</span>
                                        <span class="description">{{ __('Año') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="text-center">
                            ...
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ __('UMB UES villa victoria') }}
                            </div>
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{ __('Sistema Bibliotecario') }}
                            </div>
                            <!--div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <script src="{{ asset('assets/js/crear.js') }}"></script>
                                ...
                                <div class="grid grid-cols-1 mt-5 mx-7">
                                <p class='form-control-label'>Seleccione la imagen</p>
                                            </div>
                        ...
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="password" name="old_password" id="input-current-password" class="form-control form-control-alternative{{ $errors->has('old_password') ? ' is-invalid' : '' }}" placeholder="{{ __('Contraseña anterior') }}" value="" required>
